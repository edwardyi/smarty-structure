        ...
        <div id="main-news" class="person-item">
            <div style="position:absolute;top:0px;left:0px;width:1920px;height:200px;background: #fff;">
                ...
                <div style="float:left;">
                    ...
                    <div style="float:left;margin-left:100px;margin-top:40px;"><a href="more?city_id=<?=$city_arr['city_id']?>&weekday=<?=$weekindex?>"><img src="/images/tv_layout_image/u37.png" width="250"></a></div>
                </div>
